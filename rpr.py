...
0.187
        ...
        with xx1:
            st.write(rrf[['Shear Rate','Relative Resistance to Flow', 'mmHg range']].style.background_gradient(cmap='Greens', subset=['Shear Rate','Relative Resistance to Flow']).set_properties(subset=['Shear Rate','Relative Resistance to Flow', 'mmHg range'], **{'width': '800px'}), height=555)
