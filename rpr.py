...
if menu == "Shear Rate and RRF":
    try:
        ...
        st.radio("Label", help="Relative viscosity values have been computed from water controls as of 10/10/22",options=[''], label_visibility='hidden',disabled=True)
