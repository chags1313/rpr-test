...
def processing(uploaded_file):
        ...
        avg_curve1['Viscosity Equation1'] = ((avg_curve1['Shear Stress'] * (0.686 /1000)) / (4.9 x 10**-4)) / avg_curve1['Shear Rate']
