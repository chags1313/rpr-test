...
def processing(uploaded_file):
        ...
        avg_curve1['Viscosity Equation1'] = ((avg_curve1['Shear Stress'] * (0.686 /1000)) / (3.81 * 10**-2)) / avg_curve1['Shear Rate']
...
if menu == "Shear Rate and RRF":
    try:
        ...
        shears = px.scatter(rrf, x='Shear Rate', y = 'Viscosity', color_discrete_sequence=['orange'], trendline="lowess", trendline_options=dict(frac=0.09))
