...
0.187
        ...
        with xx1:
            st.dataframe(rrf[['Shear Rate','Relative Resistance to Flow', 'mmHg range']].style.background_gradient(cmap='Greens', subset=['Shear Rate','Relative Resistance to Flow']), height=1000)
