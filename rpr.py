...
with tab4:
    if uploaded_file is not None:
        ...
        #colored_header("Shear Rates")
            ...
            shearbox.update_layout(xaxis_title = 'Shear Rate',hovermode='x unified', height = 250, width = 525)
        ...
        #colored_header("Flows")
            ...
            flowbox.update_layout(xaxis_title = 'Relative Resistance to Flow',hovermode='x unified', height = 250, width=525)
