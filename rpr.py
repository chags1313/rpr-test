...
if menu == "Shear Rate and RRF":
    try:
        ...
        slid = st.slider("Enter Shear Rate", min_value = 0.0, value = 0.0,max_value = 500.0, step = 0.5, help ='Enter a Shear Rate to Take a Deeper Look at the Data', label_visibility='collapsed')
